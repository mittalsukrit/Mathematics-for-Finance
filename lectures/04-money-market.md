...
* **Today (t=0):** 
  - Borrow $P_2 = 0.91$ for 2 years (short the 2-year zero)
  - Invest $P_1 = 0.95$ for 1 year (buy the 1-year zero)
  - Enter forward contract to invest at rate $F = 0.94$ from year 1 to year 2 (costs 0)
  - **Net cash outflow:** $0.95 - 0.91 = 0.04$ (borrow an additional 0.04 at 2-year rate)

* **Year 1 (t=1):**
  - Receive 1 unit from maturing 1-year zero
  - Pay $F = 0.94$ for forward contract (invest for 1 more year)
  - **Net cash flow:** $1 - 0.94 = 0.06$ (free cash!)

* **Year 2 (t=2):**
  - Receive 1 unit from forward contract investment
  - Repay 1 unit on the 2-year borrowing
  - **Net cash flow:** $1 - 1 = 0$
